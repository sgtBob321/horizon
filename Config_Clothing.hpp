...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
            { "NONE", "Remove", 0, "" },
            { "MET_black_Uniform", "Uniform", 0, "call life_coplevel >= 1" },
            { "psni_Uniform", "", 0, "call life_coplevel >= 1" },
            { "MET_white_Uniform", "", 0, "call life_coplevel >= 2" },
            { "psni_tsg_Unifor", "", 0, "call life_coplevel >= 1" },
            { "sco19_Uniform", "", 0, "call life_coplevel >= 4" }
        };
        headgear[] = {
            { "NONE", "Remove", 0, "" },
            { "psni_cap", "", 0, "call life_coplevel >= 1" },
            { "NSWDG_Helmet_M_FastXP_Machine_Blk", "", 0, "call life_coplevel >= 4" },
            { "psni_cap2", "", 0, "call life_coplevel >= 1" },
            { "NSWDG_Earpiece", "", 0, "call life_coplevel >= 1" }
        };
        goggles[] = {
            { "NONE", "Remove", 0, "" },
        ...
        vests[] = {
            { "NONE", "Remove", 0, "" },
            { "TRYK_V_tacv1_P_BK", "", 0, "call life_coplevel >= 1" },
            { "TRYK_V_tacv1LP_BK", "", 0, "call life_coplevel >= 1" },
            { "V_SGT_N7Vest", "", 0, "call life_coplevel >= 1" },
            { "EF_MBA_POLICE", "", 0, "call life_coplevel >= 2" },
            { "TAC_PBDFG2SACP_B_1", "", 0, "call life_coplevel >= 4" }
        };
        backpacks[] = {
            { "NONE", "Remove", 0, "" },
            { "AM_PoliceBelt", "Duty Belt", 0, "" },
            { "TAC_LBT_LEGAB2_BK", "", 0, "call life_coplevel >= 4" }
        };
    };
